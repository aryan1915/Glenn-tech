...
<div class="rd-body">
  ...
  <section class="rd-hero">
    <div class="rd-hero-container">
      <span class="rd-hero-badge">CRM Integrations</span>
      <h1 class="rd-hero-title">CRM Consulting Services</h1>
      <p class="rd-hero-desc">
        Customize, integrate, and automate your Salesforce, Microsoft Dynamics, or custom CRM to boost sales efficiency and customer satisfaction.
      </p>
    ...
    <div class="container-n">
      ...
      <div class="rd-stats-grid">
        ...
        <div class="rd-stat-card">
          ...
          <div class="rd-stat-label">Sales Efficiency Gain</div>
        </div>
        
        <div class="rd-stat-card">
          <div class="rd-stat-number">-40%</div>
          <div class="rd-stat-label">Manual Input Time</div>
        </div>
        
        <div class="rd-stat-card">
          <div class="rd-stat-number">100%</div>
          <div class="rd-stat-label">Data Sync Accuracy</div>
        </div>
        
        <div class="rd-stat-card">
          <div class="rd-stat-number">2.5x</div>
          <div class="rd-stat-label">Pipeline Visibility</div>
        </div>
    ...
    <div class="container-n">
      ...
      <div class="rd-grid-3">
        ...
        <div class="rd-card">
          ...
          <h3 class="rd-card-title">Workflow Customization</h3>
          <p class="rd-card-desc">
            Tailor pipeline views, user dashboards, automated notifications, and customer categories to match your actual sales team.
          </p>
        </div>
        ...
        <div class="rd-card">
          ...
          <h3 class="rd-card-title">Omnichannel Integration</h3>
          <p class="rd-card-desc">
            Connect CRM seamlessly with phone lines, email pipelines, custom website database logs, and support desks.
          </p>
        </div>
        ...
        <div class="rd-card">
          ...
          <h3 class="rd-card-title">Predictive Analytics</h3>
          <p class="rd-card-desc">
            Utilize automated machine learning models to forecast monthly revenue, deal probabilities, and customer churn.
          </p>
        </div>
      ...
      <div class="rd-timeline">
        ...
        <div class="rd-timeline-item">
          ...
          <div class="rd-timeline-content">
            <h3 class="rd-timeline-title">Workflow Audit</h3>
            <p class="rd-timeline-desc">
              Shadow your sales reps and support agents to catalog manual tasks and data entry loops.
            </p>
          </div>
        </div>
        ...
        <div class="rd-timeline-item">
          ...
          <div class="rd-timeline-content">
            <h3 class="rd-timeline-title">CRM Design</h3>
            <p class="rd-timeline-desc">
              Design database relationships, page layouts, and automated actions in Salesforce/Dynamics.
            </p>
          </div>
        </div>
        ...
        <div class="rd-timeline-item">
          ...
          <div class="rd-timeline-content">
            <h3 class="rd-timeline-title">API Integration</h3>
            <p class="rd-timeline-desc">
              Link ERP, payment processors, and email channels directly into the CRM database.
            </p>
          </div>
        </div>
        ...
        <div class="rd-timeline-item">
          ...
          <div class="rd-timeline-content">
            <h3 class="rd-timeline-title">User Handover</h3>
            <p class="rd-timeline-desc">
              Conduct employee onboarding workshops and deliver custom user reference decks.
            </p>
          </div>
        </div>
...
export default function Page() {
  return (
    <PageWrapper
      title="Search for:"
      description="Rely on Glenn Tech&#039; CRM consulting and implementation services to optimize for your marketing, sales, and customer management processes."
      bodyClass="wp-singular services-template-default single single-services postid-55264 wp-theme-eleks siteorigin-panels siteorigin-panels-before-js"
      html={bodyHtml}
    />
  );
}
