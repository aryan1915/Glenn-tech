...
<div class="rd-body">
  ...
  <section class="rd-hero">
    <div class="rd-hero-container">
      <span class="rd-hero-badge">Enterprise Software</span>
      <h1 class="rd-hero-title">Enterprise Applications Development</h1>
      <p class="rd-hero-desc">
        Design, develop, and integrate resilient software systems built to streamline enterprise operations and improve collaboration.
      </p>
    ...
    <div class="container-n">
      ...
      <div class="rd-stats-grid">
        ...
        <div class="rd-stat-card">
          ...
          <div class="rd-stat-label">Operational Efficiency</div>
        </div>
        
        <div class="rd-stat-card">
          <div class="rd-stat-number">100%</div>
          <div class="rd-stat-label">Auditable Log Capture</div>
        </div>
        
        <div class="rd-stat-card">
          <div class="rd-stat-number">99.99%</div>
          <div class="rd-stat-label">System Uptime</div>
        </div>
        
        <div class="rd-stat-card">
          <div class="rd-stat-number">10M+</div>
          <div class="rd-stat-label">Daily Data Records</div>
        </div>
    ...
    <div class="container-n">
      ...
      <div class="rd-grid-3">
        ...
        <div class="rd-card">
          ...
          <h3 class="rd-card-title">Enterprise Integrations</h3>
          <p class="rd-card-desc">
            Connect decoupled CRM, ERP, and operational databases together using high-throughput event buses and API gateways.
          </p>
        </div>
        ...
        <div class="rd-card">
          ...
          <h3 class="rd-card-title">Workflow Automation</h3>
          <p class="rd-card-desc">
            Eliminate manual handovers, email approvals, and file uploads using secure, script-based trigger systems.
          </p>
        </div>
        ...
        <div class="rd-card">
          ...
          <h3 class="rd-card-title">Enterprise Compliance</h3>
          <p class="rd-card-desc">
            Develop secure software that conforms to HIPAA, GDPR, SOC2, and localized financial auditing guidelines.
          </p>
        </div>
      ...
      <div class="rd-timeline">
        ...
        <div class="rd-timeline-item">
          ...
          <div class="rd-timeline-content">
            <h3 class="rd-timeline-title">Context Discovery</h3>
            <p class="rd-timeline-desc">
              Identify data isolation boundaries, operational stakeholders, and process dependencies.
            </p>
          </div>
        </div>
        ...
        <div class="rd-timeline-item">
          ...
          <div class="rd-timeline-content">
            <h3 class="rd-timeline-title">Architecture Blueprinting</h3>
            <p class="rd-timeline-desc">
              Draft database relationships, network access controls, and modular microservices.
            </p>
          </div>
        </div>
        ...
        <div class="rd-timeline-item">
          ...
          <div class="rd-timeline-content">
            <h3 class="rd-timeline-title">Development & Integration</h3>
            <p class="rd-timeline-desc">
              Build the core business rules engine and sync external systems via APIs.
            </p>
          </div>
        </div>
        ...
        <div class="rd-timeline-item">
          ...
          <div class="rd-timeline-content">
            <h3 class="rd-timeline-title">UAT & Compliance Check</h3>
            <p class="rd-timeline-desc">
              Obtain stakeholder confirmation through user testing and execute security auditing.
            </p>
          </div>
        </div>
...
export default function Page() {
  return (
    <PageWrapper
      title="Search for:"
      description="Rely on our enterprise application development services to optimize your business processes, your human capital, and resource-management operations."
      bodyClass="wp-singular services-template-default single single-services postid-54956 wp-theme-eleks siteorigin-panels siteorigin-panels-before-js"
      html={bodyHtml}
    />
  );
}
