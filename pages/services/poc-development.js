...
<div class="rd-body">
  ...
  <section class="rd-hero">
    <div class="rd-hero-container">
      <span class="rd-hero-badge">Concept Validation</span>
      <h1 class="rd-hero-title">PoC Development Services</h1>
      <p class="rd-hero-desc">
        Validate your most innovative ideas, demonstrate technical feasibility, and launch lightweight prototypes quickly with minimal risk.
      </p>
    ...
    <div class="container-n">
      ...
      <div class="rd-stats-grid">
        ...
        <div class="rd-stat-card">
          <div class="rd-stat-number">4-Week</div>
          <div class="rd-stat-label">Average Timeline</div>
        </div>
        
        <div class="rd-stat-card">
          <div class="rd-stat-number">95%+</div>
          <div class="rd-stat-label">Investment Risk Mitigated</div>
        </div>
        
        <div class="rd-stat-card">
          <div class="rd-stat-number">100%</div>
          <div class="rd-stat-label">Technical Clarity</div>
        </div>
        
        <div class="rd-stat-card">
          <div class="rd-stat-number">3x</div>
          <div class="rd-stat-label">Faster Executive Signoff</div>
        </div>
    ...
    <div class="container-n">
      ...
      <div class="rd-grid-3">
        ...
        <div class="rd-card">
          ...
          <h3 class="rd-card-title">Technical Feasibility</h3>
          <p class="rd-card-desc">
            Validate third-party API performance, hardware interfaces, and complex mathematical algorithms before high investment.
          </p>
        </div>
        ...
        <div class="rd-card">
          ...
          <h3 class="rd-card-title">Rapid Prototype</h3>
          <p class="rd-card-desc">
            Construct clean frontend screens with mock database data to pitch concept designs to stakeholders and early users.
          </p>
        </div>
        ...
        <div class="rd-card">
          ...
          <h3 class="rd-card-title">MVP Roadmap Outlining</h3>
          <p class="rd-card-desc">
            Translate key learnings from the PoC to design the full minimum viable product (MVP) scope and backlogs.
          </p>
        </div>
      ...
      <div class="rd-timeline">
        ...
        <div class="rd-timeline-item">
          ...
          <div class="rd-timeline-content">
            <h3 class="rd-timeline-title">Validation Scope</h3>
            <p class="rd-timeline-desc">
              Identify critical technical unknowns, integrations, and target milestones.
            </p>
          </div>
        </div>
        ...
        <div class="rd-timeline-item">
          ...
          <div class="rd-timeline-content">
            <h3 class="rd-timeline-title">Interface Sketching</h3>
            <p class="rd-timeline-desc">
              Map simple wireframes and user interaction click paths.
            </p>
          </div>
        </div>
        ...
        <div class="rd-timeline-item">
          ...
          <div class="rd-timeline-content">
            <h3 class="rd-timeline-title">Sprint Coding</h3>
            <p class="rd-timeline-desc">
              Construct a lightweight app structure focused exclusively on the critical hypothesis.
            </p>
          </div>
        </div>
        ...
        <div class="rd-timeline-item">
          ...
          <div class="rd-timeline-content">
            <h3 class="rd-timeline-title">Validation Handover</h3>
            <p class="rd-timeline-desc">
              Present feasibility performance results and map out the MVP roadmap.
            </p>
          </div>
        </div>
...
export default function Page() {
  return (
    <PageWrapper
      title="Search for:"
      description="Glenn Tech’ PoC Development service allows you to safely explore ideas and new technologies that could enhance business efficiency and improve customer service."
      bodyClass="wp-singular services-template-default single single-services postid-8801 wp-theme-eleks siteorigin-panels siteorigin-panels-before-js"
      html={bodyHtml}
    />
  );
}
