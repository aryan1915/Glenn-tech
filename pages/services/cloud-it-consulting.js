...
import { ArrowRight, CheckCircle, HelpCircle, Server } from 'lucide-react';
import ModernLayout from '../../components/ModernLayout';
import ScrollReveal from '../../components/ScrollReveal';

export default function CloudITConsulting() {
  const deliverables = [
    'Cloud strategy and migration planning',
    'IT infrastructure assessment and roadmap',
  ...
  const steps = [
    { num: '01', title: 'Assess', desc: 'We review your current systems, costs, and risks.' },
    { num: '02', title: 'Plan', desc: 'We build a right-sized roadmap and budget.' },
    { num: '03', title: 'Execute', desc: 'We migrate and implement in safe stages.' },
    { num: '04', title: 'Advise', desc: 'We stay on as your practical IT partner.' }
  ];
          ...
          <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
            <ScrollReveal>
              ...
              <h1 style={{ fontSize: '60px', margin: '16px 0 24px 0', fontWeight: 800 }} className="gt-text-gradient">
                IT strategy that fits where you actually are.
              </h1>
            </ScrollReveal>
          </div>
        </div>
          ...
          <div className="gt-grid-2" style={{ alignItems: 'center' }}>
            <ScrollReveal>
              ...
              <p style={{ fontSize: '16px', color: 'var(--text-gray-400)', lineHeight: '1.7', marginBottom: '32px' }}>
                We provide unbiased guidance, cloud migration coordination, and ongoing consulting scaled to your true operation.
              </p>
            ...
            <ScrollReveal delay={150}>
              <div style={{ padding: '32px', background: 'rgba(255,255,255,0.01)', border: '1px solid var(--border-color)', borderRadius: '16px' }}>
                <h3 style={{ fontSize: '20px', fontWeight: 700, margin: '0 0 16px 0', color: '#fff' }}>Our Core Pillars</h3>
                <ul style={{ paddingLeft: '20px', color: 'var(--text-gray-400)', fontSize: '14.5px', display: 'flex', flexDirection: 'column', gap: '12px', margin: 0 }}>
                  <li>Vendor-neutral tool auditing</li>
                  <li>Sized for commercial & public-sector frameworks</li>
                  <li>Cost and cloud-bill optimization models</li>
                  <li>Enterprise access controls & security advisory</li>
                </ul>
              </div>
            </ScrollReveal>
          </div>
        ...
        <div className="gt-container">
          <div style={{ textAlign: 'center', marginBottom: '60px' }}>
            <ScrollReveal>
              ...
              <p style={{ color: 'var(--text-gray-400)', fontSize: '16.5px' }}>Our neutral, step-by-step IT strategy cycles.</p>
            </ScrollReveal>
          </div>
