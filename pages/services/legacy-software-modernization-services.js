...
<div class="rd-body">
  ...
  <section class="rd-hero">
    <div class="rd-hero-container">
      <span class="rd-hero-badge">Software Modernization</span>
      <h1 class="rd-hero-title">Legacy Software Modernization</h1>
      <p class="rd-hero-desc">
        Refactor outdated monoliths, optimize infrastructure cost, and upgrade legacy user screens to modern, fast responsive web platforms.
      </p>
    ...
    <div class="container-n">
      ...
      <div class="rd-stats-grid">
        ...
        <div class="rd-stat-card">
          <div class="rd-stat-number">5x</div>
          <div class="rd-stat-label">Performance Speedup</div>
        </div>
        
        <div class="rd-stat-card">
          <div class="rd-stat-number">-65%</div>
          <div class="rd-stat-label">Design & Code Debt</div>
        </div>
        
        <div class="rd-stat-card">
          <div class="rd-stat-number">100%</div>
          <div class="rd-stat-label">LTS Stack Security</div>
        </div>
        
        <div class="rd-stat-card">
          <div class="rd-stat-number">Zero</div>
          <div class="rd-stat-label">Operational Disruptions</div>
        </div>
      ...
      <div class="rd-grid-3">
        ...
        <div class="rd-card">
          <div class="rd-card-icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline></svg>
          </div>
          <h3 class="rd-card-title">Monolith to Microservices</h3>
          <p class="rd-card-desc">
            Safely deconstruct massive codebase monoliths into modular cloud APIs using the strangler fig pattern.
          </p>
        </div>
        
        <div class="rd-card">
          <div class="rd-card-icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
          </div>
          <h3 class="rd-card-title">Modern UI/UX Refactoring</h3>
          <p class="rd-card-desc">
            Rebuild old desktop screens into responsive, fast mobile and web interfaces with seamless visual workflows.
          </p>
        </div>
        ...
        <div class="rd-card">
          ...
          <h3 class="rd-card-title">Stack & Dependency Upgrade</h3>
          <p class="rd-card-desc">
            Migrate obsolete framework languages (.NET Framework, PHP 5, Python 2) to current LTS versions.
          </p>
        </div>
      ...
      <div class="rd-timeline">
        ...
        <div class="rd-timeline-item">
          ...
          <div class="rd-timeline-content">
            <h3 class="rd-timeline-title">Codebase Inspection</h3>
            <p class="rd-timeline-desc">
              Analyze class structures, circular references, and dead dependencies.
            </p>
          </div>
        </div>
        ...
        <div class="rd-timeline-item">
          ...
          <div class="rd-timeline-content">
            <h3 class="rd-timeline-title">Migration Mapping</h3>
            <p class="rd-timeline-desc">
              Determine target frameworks, API endpoints, and data routing paths.
            </p>
          </div>
        </div>
        ...
        <div class="rd-timeline-item">
          ...
          <div class="rd-timeline-content">
            <h3 class="rd-timeline-title">Strangled Refactoring</h3>
            <p class="rd-timeline-desc">
              Rebuild subsystems piece by piece while redirecting live traffic.
            </p>
          </div>
        </div>
        ...
        <div class="rd-timeline-item">
          ...
          <div class="rd-timeline-content">
            <h3 class="rd-timeline-title">Visual Upgrade</h3>
            <p class="rd-timeline-desc">
              Deliver a responsive web layout and migrate database systems.
            </p>
          </div>
        </div>
...
export default function Page() {
  return (
    <PageWrapper
      title="Search for:"
      description="With Glenn Tech&#039; legacy software modernization services, you can transform your outdated apps to boost performance, security, scalability and UX."
      bodyClass="wp-singular services-template-default single single-services postid-99885 wp-theme-eleks siteorigin-panels siteorigin-panels-before-js"
      html={bodyHtml}
    />
  );
}
