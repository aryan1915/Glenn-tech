...
import { ArrowRight, CheckCircle, HelpCircle, Eye } from 'lucide-react';
import ModernLayout from '../../components/ModernLayout';
import ScrollReveal from '../../components/ScrollReveal';

export default function BrandStrategyIdentity() {
  const deliverables = [
    'Brand positioning and messaging strategy',
    'Logo and complete visual identity systems',
    'Brand guidelines your whole team can apply',
    'Collateral: decks, one-pagers, templates, social assets',
    'Naming and tone-of-voice support'
  ];

  const steps = [
    { num: '01', title: 'Audit', desc: "We assess how you're seen today and where the gaps are." },
    { num: '02', title: 'Position', desc: 'We define your positioning and core messages.' },
    { num: '03', title: 'Design', desc: 'We create the identity system and guidelines.' },
    { num: '04', title: 'Roll out', desc: 'We apply it across every touchpoint.' }
  ];

  return (
    <ModernLayout
      title="Brand Strategy & Visual Identity Services"
      description="Brand positioning, messaging, and visual identity systems that make your organization look as capable as it is."
    >
              ...
              <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }} className="flex-col-mobile">
                ...
                <div>
                  ...
                  <p style={{ fontSize: '16px', color: 'var(--text-gray-400)', lineHeight: '1.7', margin: 0 }}>
                    A logo is the smallest part of a brand. What actually moves people is clarity: knowing who you are, what you stand for, and why you're the safe choice. We build that clarity, then dress it in an identity that looks the part.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="gt-grid-2" style={{ alignItems: 'center' }}>
            <ScrollReveal>
              ...
              <p style={{ fontSize: '16px', color: 'var(--text-gray-400)', lineHeight: '1.7', marginBottom: '32px' }}>
                We deliver comprehensive identity structures that make your organization look as capable as it truly is.
              </p>
            ...
            <ScrollReveal delay={150}>
              <div style={{ padding: '32px', background: 'rgba(255,255,255,0.01)', border: '1px solid var(--border-color)', borderRadius: '16px' }}>
                <h3 style={{ fontSize: '20px', fontWeight: 700, margin: '0 0 16px 0', color: '#fff' }}>Brand Consistency</h3>
                <ul style={{ paddingLeft: '20px', color: 'var(--text-gray-400)', fontSize: '14.5px', display: 'flex', flexDirection: 'column', gap: '12px', margin: 0 }}>
                  <li>Sleek presentations templates (PowerPoint, Keynote)</li>
                  <li>Formatted one-pagers and brochures</li>
                  <li>Ready-to-use social media templates</li>
                  <li>Dynamic digital assets aligned to your guidelines</li>
                </ul>
              </div>
            </ScrollReveal>
          </div>
        ...
        <div className="gt-container">
          <div style={{ textAlign: 'center', marginBottom: '60px' }}>
            <ScrollReveal>
              ...
              <p style={{ color: 'var(--text-gray-400)', fontSize: '16.5px' }}>Our collaborative design lifecycle.</p>
            </ScrollReveal>
          </div>
