...
<div class="rd-body">
  ...
  <section class="rd-hero">
    <div class="rd-hero-container">
      <span class="rd-hero-badge">Security & Compliance</span>
      <h1 class="rd-hero-title">Cyber Security Services</h1>
      <p class="rd-hero-desc">
        Protect your enterprise applications, customer data, and cloud infrastructure from threats with state-of-the-art security consulting.
      </p>
    ...
    <div class="container-n">
      ...
      <div class="rd-stats-grid">
        ...
        <div class="rd-stat-card">
          <div class="rd-stat-number">Zero</div>
          <div class="rd-stat-label">Security Breaches</div>
        </div>
        
        <div class="rd-stat-card">
          <div class="rd-stat-number">100%</div>
          <div class="rd-stat-label">Compliance Reached</div>
        </div>
        
        <div class="rd-stat-card">
          <div class="rd-stat-number">24/7</div>
          <div class="rd-stat-label">Threat Alerting</div>
        </div>
        
        <div class="rd-stat-card">
          <div class="rd-stat-number">< 1hr</div>
          <div class="rd-stat-label">Incident Response Time</div>
        </div>
    ...
    <div class="container-n">
      ...
      <div class="rd-grid-3">
        ...
        <div class="rd-card">
          ...
          <h3 class="rd-card-title">Vulnerability Assessment</h3>
          <p class="rd-card-desc">
            Execute automated network penetration tests and codebase scanning to spot exploits, key leakages, and vulnerabilities.
          </p>
        </div>
        ...
        <div class="rd-card">
          ...
          <h3 class="rd-card-title">Zero-Trust Architecture</h3>
          <p class="rd-card-desc">
            Implement secure identity management (IAM), multi-factor authentication (MFA), role-based control, and encrypted networks.
          </p>
        </div>
        ...
        <div class="rd-card">
          ...
          <h3 class="rd-card-title">Continuous SecOps</h3>
          <p class="rd-card-desc">
            Configure automated intrusion detection alerts, database logs monitoring, and fast incident response playbooks.
          </p>
        </div>
      ...
      <div class="rd-timeline">
        ...
        <div class="rd-timeline-item">
          ...
          <div class="rd-timeline-content">
            <h3 class="rd-timeline-title">Security Audit</h3>
            <p class="rd-timeline-desc">
              Run complete automated scans and manual audits to assess your software risk surface.
            </p>
          </div>
        </div>
        ...
        <div class="rd-timeline-item">
          ...
          <div class="rd-timeline-content">
            <h3 class="rd-timeline-title">Threat Modeling</h3>
            <p class="rd-timeline-desc">
              Create concrete scenarios of possible threat attacks to target the most crucial entry flaws.
            </p>
          </div>
        </div>
        ...
        <div class="rd-timeline-item">
          ...
          <div class="rd-timeline-content">
            <h3 class="rd-timeline-title">Remediation Sprints</h3>
            <p class="rd-timeline-desc">
              Secure database encryptions, upgrade dependencies, and lock network access lists.
            </p>
          </div>
        </div>
        ...
        <div class="rd-timeline-item">
          ...
          <div class="rd-timeline-content">
            <h3 class="rd-timeline-title">Continuous Guard</h3>
            <p class="rd-timeline-desc">
              Setup automated security scanners and firewalls to block runtime anomalies.
            </p>
          </div>
        </div>
    ...
    <div class="container-n">
      <div style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 60px; align-items: start;">
        ...
        <div class='gform-footer gform_footer top_label'> <input type='submit' id='gform_submit_button_1' class='gform_button button' onclick='gform.submission.handleButtonClick(this);' data-submission-type='submit' value="Contact us"  /> <input type='hidden' name='gform_ajax' value="form_id=1&amp;title=&amp;description=&amp;tabindex=0&amp;theme=legacy&amp;hash=036d8bc2de2c65c71131ae920675665d" />
            ...
            <input type='hidden' class='gform_hidden' name='gform_currency' data-currency='USD' value="v2MsgSaAJopdUBgiK00ypACOgobpR6NZdKk2I9IcxDsmihOKh2ZxEUmyoNwbTZxeoLixUCnQumg2IrGxLfcHpFCdiCIbuOnkksQx1gr5QqonPIA=" />
            ...
            <input type='hidden' name='gform_field_values' value="" />
                        ...
                        <p style="display: none !important;" class="akismet-fields-container" data-prefix="ak_"><label>&#916;<textarea name="ak_hp_textarea" cols="45" rows="8" maxlength="100"></textarea></label><input type="hidden" id="ak_js_1" name="ak_js" value="69"/>
</p></form>
                        </div>
...
export default function Page() {
  return (
    <PageWrapper
      title="Search for:"
      description="Glenn Tech’ cyber security services help you proactively identify threats to your digital infrastructure, so you can respond rapidly, minimise costs and losses and prevent future attacks."
      bodyClass="wp-singular services-template-default single single-services postid-8800 wp-theme-eleks siteorigin-panels siteorigin-panels-before-js"
      html={bodyHtml}
    />
  );
}
