...
<div class="rd-body">
  ...
  <section class="rd-hero">
    <div class="rd-hero-container">
      <span class="rd-hero-badge">Migration & Optimization</span>
      <h1 class="rd-hero-title">Cloud Migration Services</h1>
      <p class="rd-hero-desc">
        Migrate legacy workloads and enterprise infrastructure to the cloud safely with minimal downtime and zero data loss.
      </p>
    ...
    <div class="container-n">
      ...
      <div class="rd-stats-grid">
        ...
        <div class="rd-stat-card">
          ...
          <div class="rd-stat-label">Data Loss Recorded</div>
        </div>
        
        <div class="rd-stat-card">
          <div class="rd-stat-number">60%</div>
          <div class="rd-stat-label">Migration Speed Boost</div>
        </div>
        
        <div class="rd-stat-card">
          <div class="rd-stat-number">99.95%</div>
          <div class="rd-stat-label">Cutover SLA</div>
        </div>
        
        <div class="rd-stat-card">
          <div class="rd-stat-number">100%</div>
          <div class="rd-stat-label">Secure Compliance</div>
        </div>
    ...
    <div class="container-n">
      ...
      <div class="rd-grid-3">
        ...
        <div class="rd-card">
          ...
          <h3 class="rd-card-title">Zero-Downtime Migration</h3>
          <p class="rd-card-desc">
            Execute application and database shifts safely using background replication and staged data cutovers.
          </p>
        </div>
        ...
        <div class="rd-card">
          ...
          <h3 class="rd-card-title">Application Refactoring</h3>
          <p class="rd-card-desc">
            Containerize and rebuild monoliths into cloud-native microservices during migration to unlock performance benefits.
          </p>
        </div>
        ...
        <div class="rd-card">
          ...
          <h3 class="rd-card-title">Security & Compliance Audits</h3>
          <p class="rd-card-desc">
            Implement zero-trust security firewalls, resource policies, and complete enterprise compliance standards.
          </p>
        </div>
      ...
      <div class="rd-timeline">
        ...
        <div class="rd-timeline-item">
          ...
          <div class="rd-timeline-content">
            <h3 class="rd-timeline-title">Dependency Discovery</h3>
            <p class="rd-timeline-desc">
              Ingest database mappings, API links, and configuration files to prevent transfer disruptions.
            </p>
          </div>
        </div>
        ...
        <div class="rd-timeline-item">
          ...
          <div class="rd-timeline-content">
            <h3 class="rd-timeline-title">Migration Blueprinting</h3>
            <p class="rd-timeline-desc">
              Select AWS/Azure/GCP target profiles and formulate resource migration scripts.
            </p>
          </div>
        </div>
        ...
        <div class="rd-timeline-item">
          ...
          <div class="rd-timeline-content">
            <h3 class="rd-timeline-title">Staged Execution</h3>
            <p class="rd-timeline-desc">
              Migrate non-critical systems, then data tiers, with background synchronization.
            </p>
          </div>
        </div>
        ...
        <div class="rd-timeline-item">
          ...
          <div class="rd-timeline-content">
            <h3 class="rd-timeline-title">Validation & Audit</h3>
            <p class="rd-timeline-desc">
              Perform penetrative security audits and latency tests before final DNS cutover.
            </p>
          </div>
        </div>
...
export default function Page() {
  return (
    <PageWrapper
      title="Search for:"
      description="Glenn Tech’ Cloud migration service helps you get the most from your digital infrastructure – improving efficiency, reducing costs and promoting agility."
      bodyClass="wp-singular services-template-default single single-services postid-9894 wp-theme-eleks siteorigin-panels siteorigin-panels-before-js"
      html={bodyHtml}
    />
  );
}
